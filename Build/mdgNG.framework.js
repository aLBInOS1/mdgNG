...
var ASM_CONSTS = {
  2364316: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2364371: function($0) {performance.now = function() { return $0; };},  
 2364419: function($0) {performance.now = function() { return $0; };},  
 2364467: function() {performance.now = Module['emscripten_get_now_backup'];},  
 2364522: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2364583: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2364647: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _MakePurchase(data) {
      purchase(UTF8ToString(data));
    }
  ...
  function _ShowCommonADV() {
      showFullscrenAd();
    }

  function _ShowRewardADV() {
      showRewardedAd();
    }
...
var asmLibraryArg = {
  ...
  "MakePurchase": _MakePurchase,
  "SetData": _SetData,
  "ShowCommonADV": _ShowCommonADV,
  "ShowRewardADV": _ShowRewardADV,
